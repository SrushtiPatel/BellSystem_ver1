...
import com.mt.bell.adapter.NavDrawerListAdapter;
import com.mt.bell.model.NavDrawerItem;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences pref = this.getSharedPreferences(Utils.PREF_FILE_NAME, this.MODE_PRIVATE);
		String systemPassword = pref.getString("password", "");
		if(systemPassword.equalsIgnoreCase("")){
			
			Editor editor = pref.edit();
			editor.putString("password", Utils.SYSTEM_PASSWORD);
			editor.commit();
